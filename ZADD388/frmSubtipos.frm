...
Private Sub Controles_Aceptar(EsNuevo As Boolean)
    ...
    If EsNuevo Then
        ...
        iClave = Format(Funciones.Get_AutoClave("Subtipo_Servicio", "Ss_Cve_Subtipo_Servicio"), Variables.GetValor("FTO_SUBTIPO_SERVICIO", vLocal))
        
        SQL = ""
        SQL = SQL & "INSERT INTO Subtipo_Servicio("
        SQL = SQL & "Ss_Cve_Subtipo_Servicio, "
        SQL = SQL & "Ss_Descripcion, "
        SQL = SQL & "Oper_Alta, "
        SQL = SQL & "Fecha_Alta, "
    ...
    Else
        ...
        SQL = ""
        SQL = SQL & "UPDATE Subtipo_Servicio SET "
        SQL = SQL & "   Ss_Descripcion = '" & txt_Descripcion.Text & "', "
        SQL = SQL & "   Oper_Ult_Modif = '" & sOper & "', "
        SQL = SQL & "   Fecha_Ult_Modif = '" & sFecha & "' "
        SQL = SQL & "WHERE "
        SQL = SQL & "   Ss_Cve_Subtipo_Servicio = '" & txtClave.Text & "' "
...
Private Sub Controles_Eliminar()
    ...
    Funciones.AgregaComentario "Subtipo_Servicio", txtClave.Text, "Baja"
...
Private Sub Controles_Info()
    ...
    X.Info "Subtipo_Servicio", "Ss_Cve_Subtipo_Servicio", txtClave.Text
    Set X = Nothing
End Sub
...
Private Sub Controles_Reactivar()
    ...
    Funciones.AgregaComentario "Subtipo_Servicio", txtClave.Text, "Reactivación"
...
Private Sub Form_Load()
    ...
    txtClave.FormatoPersonal = Variables.GetValor("FTO_SUBTIPO_SERVICIO", vLocal)
    
    SQL = ""
    SQL = SQL & "SELECT TOP 100 "
    SQL = SQL & "   Ss_Cve_Subtipo_Servicio AS CLAVE, "
    SQL = SQL & "   Ss_Descripcion AS DESCRIPCION "
    SQL = SQL & "FROM Subtipo_Servicio "
    SQL = SQL & "WHERE "
    SQL = SQL & "   Ss_Cve_Subtipo_Servicio LIKE ? OR "
    SQL = SQL & "   Ss_Descripcion LIKE ? "
    SQL = SQL & "ORDER BY "
    SQL = SQL & "   Ss_Cve_Subtipo_Servicio"
...
Private Sub txtClave_Enter()
    ...
    SQL = ""
    SQL = "SELECT * FROM Subtipo_Servicio WHERE Ss_Cve_Subtipo_Servicio = '" & txtClave.Text & "'"
    ...
    txt_Descripcion.Text = rs!Ss_Descripcion
